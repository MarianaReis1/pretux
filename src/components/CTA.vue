        ...
        <div class="lg:hidden">
            ...
            <carousel :settings="settings" data-carousel="cta">
                <slide v-for="slide in data.items" :key="slide" >
                    ...
                    <a :href="slide.carousel_link" class="bg-black-700/20 grid place-items-center p-2 rounded-2xl w-full max-w-[193px] mx-2">
...
[data-carousel="cta"] {
    ...
    .carousel__next {
        @apply bg-transparent w-14 h-14 -right-22;
